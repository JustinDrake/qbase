    ...
    function populate_dropdown (query, results) {
        if(results && results.length) {
            ...
            $.each(results, function(index, value) {
                ...
                this_li = find_value_and_highlight_term(this_li ,value, query);
        ...
        if(cached_results) {
            ...
            if(settings.url) {
                ...
                ajax_params.success = function(results) {
                  ...
                  cache.add(cache_key, settings.jsonContainer ? results[settings.jsonContainer] : results[1]); // CHANGED

                  // only populate the dropdown if the results are associated with the active search query
                  if(input_box.val() === query) {
                      populate_dropdown(query, settings.jsonContainer ? results[settings.jsonContainer] : results[1]); // CHANGED
                  }
                };
