      ...
      function addMembers(etext, data) {
        ...
        if (data != null && data.length) {
          $.each(data, function(i, val) {
            cache.set(xssPrevent(val), xssPrevent(val));
          });
        }
        ...
        $.each(cache.search(etext), function (i, object) {
          if (maximum) {
            if (options.filter_selected && element.children('option[value="' + object + '"]').hasClass("selected")) {
              //nothing here...
            } else {
              content += '<li rel="' + object + '">' + xssDisplay(itemIllumination(object.value, etext)) + '</li>';
              counter++;
              maximum--;
            }
          }
